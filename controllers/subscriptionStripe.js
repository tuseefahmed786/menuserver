...
exports.subscriptionStripe = async (req, res) => {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      success_url:
        "https://www.qr.cloudymenu.com/dashboard/PaymentDone?session_id={CHECKOUT_SESSION_ID}", // Attach session ID
      cancel_url: "https://www.qr.cloudymenu.com/dashboard/subscription", // Redirect after cancel
    });
